...
import com.engineer.fred.easyfood.databinding.SingleMealCardBinding

class FavoriteMealsAdapter : Adapter<FavoriteMealsAdapter.ItemViewHolder>() {
    ...
    inner class ItemViewHolder( private val binding : SingleMealCardBinding ) :  ViewHolder( binding.root ) {
        fun bind( meal : Meal) {
